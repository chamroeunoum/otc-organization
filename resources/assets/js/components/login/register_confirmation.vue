<template >
    <div class="layout">
        <Layout >
                    ...
                    <Col span="12" offset="9" >
                        <Card style="width:350px; margin: 120px 0px 0px; " >
                            ...
                            <Form ref="formInline" :model="formInline" :rules="ruleInline">
                                ...
                                <FormItem>
                                    <Button type="primary" :loading="btnSubmitLoading" @click="handleSubmit('formInline')" style="width: 50%; float: none; margin: 0px 25%; " >ចូល</Button>
                                </FormItem>
                                <FormItem v-if="false" >
                                    <Col span="10" offset="2" >
                                        <Button type="text" @click="" >ចូលជាសមាជិក !</Button>
                                    </Col>
                                    <Col span="10" offset="2" >
                                    <Button type="text" @click="" >ភ្លេចពាក្យសម្ងាត់ ?</Button>
                                    </Col>
                                </FormItem>
                            </Form>
                        </Card>
            ...
            <Footer>
                <div class="col-md-12 text-center" style="color: #aaa;" >អភិវឌ្ឍន៍ដោយ ៖ នាយកដ្ឋាន ឯកសារអេឡិចត្រូនិច និង ព័ត៌មានវិទ្យា</div>
            </Footer>
        </Layout>
    </div>
</template>
