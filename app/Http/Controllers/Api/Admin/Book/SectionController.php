...
class SectionController extends Controller
{
    ...
    public function __construct(){
        $this->selectedFields = ['id', 'number', 'title','regulator_id','kunty_id', 'matika_id','chapter_id','part_id','updated_at','created_by','updated_by'] ;
    }
