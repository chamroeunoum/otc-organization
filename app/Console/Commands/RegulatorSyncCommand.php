            ...
            if( $document != null && $document != false ){
                ...
                if( $regulator == null ){
                    ...
                    array_map(function($organization) use($document,$regulator){
                        ...
                        $organization = \App\Models\Regulator\Tag\Organization::where(function($query){
                            $query->where('pid',163)
                        ...
                        if( $organization == null ){
                            $organization = \App\Models\Regulator\Tag\Organization::create([
                                'name' => $name ,
                                'pid' => 163 ,
                                'tpid' => 163 ,
                            ]);
                    ...
                    array_map(function($own_organization) use($document,$regulator){
                        ...
                        $own_organization = \App\Models\Regulator\Tag\Organization::where(function($query){
                            $query->where('pid',163)
                            ->orWhere( 'model' , 'App\Models\Regulator\Tag\Orgainzation' );
                        })
                        ->where( 'name' , $name )
                        ...
                        if( $own_organization == null ){
                            $own_organization = \App\Models\Regulator\Tag\Organization::create([
                                'name' => $name ,
                                'pid' => 163 ,
                                'tpid' => 163 ,
                            ]);
                    ...
                    array_map(function($related_organization) use($document,$regulator){
                        ...
                        $related_organization = \App\Models\Regulator\Tag\Organization::where(function($query){
                            $query->where('pid',163)
                            ->orWhere( 'model' , 'App\Models\Regulator\Tag\Orgainzation' );
                        })
                        ->where( 'name' , $name )
                        ...
                        if( $related_organization == null ){
                            $related_organization = \App\Models\Regulator\Tag\Organization::create([
                                'name' => $name ,
                                'pid' => 163 ,
                                'tpid' => 163 ,
                            ]);
