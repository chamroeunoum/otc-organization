...
class People extends Model
{
  ...
  */
  ...
  protected $fillable = ['countesy_id', 'firstname', 'lastname', 'gender', 'dob', 'mobile_phone', 'office_phone', 'email', 'nid', 'father', 'mother', 'image', 'marry_status'];
  ...
  */
  ...
  public function countesy(){
      return $this->hasOne('App\Models\Countesy','id','countesy_id');
  }
  /*
  |--------------------------------------------------------------------------
  | RELATIONS
