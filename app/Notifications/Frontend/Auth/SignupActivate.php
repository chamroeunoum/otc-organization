...
class SignupActivate extends Notification
{
    ...
    public function toMail($notifiable)
    {
         ...
         */
        return (new MailMessage)
        ->subject('បញ្ជាក់ការចុះឈ្មោះ')
        ->greeting("សួស្ដី, " . $notifiable->lastname . ' ' . $notifiable->firstname )
        ->line("ខាងក្រោមជា លេខកូត ដែលអ្នកនិងត្រូវការដើម្បីបញ្ជាក់ការចុះឈ្មោះរបស់អ្នក។")
        ->line( $notifiable->activation_token )
        ->line("សូមបញ្ចូលលេខកូតនេះទៅក្នុងទំព័រ បញ្ជាក់គណនី ដើម្បីបញ្ចប់តំណើរការចុះឈ្មោះរបស់អ្នក។")
